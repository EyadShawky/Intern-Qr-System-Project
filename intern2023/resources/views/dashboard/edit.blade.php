...
@section('content')
<form action="{{ url("/admin/pdRkAAT+XxepOb8drasiSw==/dashboard/$dashboards->id") }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        <div class="container">
            <div class="input-group mb-3 w-75 m-auto">
                ...
                <input name="title" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="{{ $dashboards->title }}">
            </div>
