    ...
    @csrf
        <div class="container">
            ...
            <div class="input-group mb-3 w-75 m-auto">
                ...
                <input name="codeFlip" type="number" min="1" max="99" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="eg: 10 for A-010">
            </div>
